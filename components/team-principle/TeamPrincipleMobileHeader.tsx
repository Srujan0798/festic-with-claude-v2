...
interface TeamPrincipleMobileHeaderProps {
  user: User;
  title: string;
...
const TeamPrincipleMobileHeader: React.FC<TeamPrincipleMobileHeaderProps> = ({ user, title, showBackButton, onBack, className }) => {
  return (
    <header className={`sticky top-0 z-20 flex items-center justify-between p-4 h-16 bg-surface/80 backdrop-blur-sm border-b border-border ${className}`}>
...
export default TeamPrincipleMobileHeader;
